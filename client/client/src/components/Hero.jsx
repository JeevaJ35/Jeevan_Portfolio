...
<Reveal>
  <motion.div
    style={{ y: picY }}
    className="relative w-44 h-44 rounded-full p-1 z-10 overflow-hidden"
  ...
  src="/profile.jpg"
  alt={profile.name}
  className="w-full h-full object-cover object-top rounded-full border-4 border-white dark:border-background shadow-soft relative"
/>
